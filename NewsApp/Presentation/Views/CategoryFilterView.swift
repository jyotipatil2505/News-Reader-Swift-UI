...
struct CategoryFilterView: View {
    ...
    var body: some View {
        ...
        ScrollView(.horizontal, showsIndicators: false) {
            ...
            /// A HStack is used to layout the category items in a horizontal row.
            /// Each category is displayed as a Text view representing the category's name (category.rawValue).
            HStack(spacing: 16) {
